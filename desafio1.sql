...
INSERT INTO users (user_id, user_name, age, signing, plan_id)
VALUES
...
-- SELECT * FROM SpotifyClone.favorite_artists;
...
INSERT INTO listened_songs (user_id, song_id, listened)
VALUES
...
-- SELECT * FROM SpotifyClone.listened_songs;